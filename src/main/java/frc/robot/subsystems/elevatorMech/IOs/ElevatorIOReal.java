...
public class ElevatorIOReal implements ElevatorIO {
    ...
    public ElevatorIOReal() {
        ...
        motor1.getConfigurator().apply(new MotorOutputConfigs().withInverted(INVERT_MOTOR1));
        motor2.getConfigurator().apply(new MotorOutputConfigs().withInverted(INVERT_MOTOR2));
        motor2.setControl(new Follower(MOTOR1_ID, false));
    }
