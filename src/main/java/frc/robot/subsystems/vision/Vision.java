...
public class Vision {
    ...
    /**Vision subsystem for handling multiple cameras and estimating poses using AprilTags through PhotonVision.
     * 
     ...
     * <p>Each camera will return an Optional<VisionEstimate> which contains the estimated pose, standard deviations, and timestamp.</p>
     * 
     * @return An array of Optional<VisionEstimate> objects, each representing the estimate from a camera.
     */
     ...
     * <p>This will filter out any empty estimates and return an array of VisionEstimate objects.</p>
     * 
     ...
     * <p>This will call all registered listeners with the latest estimates.</p>
     */
     ...
     * <p>This listener will be called with the latest estimated poses whenever they are updated.</p>
     * 
     * @param listener The listener to add, which takes an array of VisionEstimate objects.
     */
    ...
    public record PVCamera(
        ...
        /**Represents a camera configuration for the Vision subsystem.
         * <p>This constructor uses the default pose estimation strategy of MULTI_TAG_PNP_ON_COPROCESSOR.</p>
         * 
         * @param name The name of the camera.
         * @param pose The pose of the camera in the field.
         * @param pre The preprocessor to apply to the camera's results.
    ...
    public class AprilTagCamera {
        ...
        /**Creates an AprilTagCamera instance for the Vision subsystem with a specific pose estimation strategy.
         * 
         * @param cam The camera settings to use for pose estimation.
         * @param fieldLayout The AprilTag field layout to use for pose estimation.
         */
         ...
         * <p>This method updates the camera's status and retrieves the latest pose estimate based on the last known pose.</p>
         * 
        ...
        public Optional<VisionEstimate> getEstimate(Pose2d lastPose) {
            ...
            return est.map(e -> {
                var estimate = cam.post().postProcess(e);
                this.lastPose = estimate.estimatedPose();
                return estimate;
            });
        }

        // Updates the camera's connection status and sends notifications if the status changes.
