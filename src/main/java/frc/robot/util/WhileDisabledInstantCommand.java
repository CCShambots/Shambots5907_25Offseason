...
public class WhileDisabledInstantCommand extends InstantCommand {
  ...
  /**
   * This command exists because the default InstandCommand doesn't run while
   * disabled, and the SMF
   * generally relies on running at least some commands while the bot is disabled
   * (especially for
